          ...
          <div class="section-body">
            ...
            <div class="card">
              ...
              <div class="card">
                ...
                <?php if($is_updatable == false){ ?><p>Drop the latest update.zip file here and after successful upload of the update.zip, click on Update Now button below to run the update.</p><?php }?>
