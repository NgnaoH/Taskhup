                        ...
                        <div class="card-body">
                          ...
                          <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-6 col-md-9">
                              ...
                              <input type="text" name="email" class="form-control" id="email-set" value="<?= !empty($dataemail->email)?$dataemail->email:'EMAIL_ADDRESS' ?>" required>
                          ...
                          <div class="form-group row align-items-center">
                            ...
                            <div class="col-sm-6 col-md-9">
                              <input type="text" name="password" class="form-control" id="password" value="<?= !empty($dataemail->password)?$dataemail->password:'PASSWORD' ?>" required>
